/**
 * @generated SignedSource<<2c0f5d3820d8f268a11ee5ea9b9c92b1>>
...
export type SecurityQuery$variables = {
  count: number;
  cursor?: string | null;
};
export type SecurityQuery$data = {
...
export type SecurityQuery = {
  response: SecurityQuery$data;
  variables: SecurityQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "9c4aa43435be80b154a439b5ced7afb2",
    "id": null,
    "metadata": {},
    "name": "SecurityQuery",
    "operationKind": "query",
...
(node as any).hash = "e9f2e14cdf4af0452e79b3b684475a43";
